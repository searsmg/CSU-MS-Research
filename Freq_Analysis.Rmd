...
if (JW_hourly$SWE_mm = 0) {JW_hourly$RainPrecip_mm = JW_hourly$Precip_mm}

  
  {JW_hourly$Precip_mm = JW_hourly$SnowPrecip_mm} 

else {JW_hourly$RainPrecip_mm = JW_hourly$Precip_mm}
